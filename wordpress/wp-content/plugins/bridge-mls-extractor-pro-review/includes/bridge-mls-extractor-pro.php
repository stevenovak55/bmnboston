...
// Plugin constants
define('BME_PRO_VERSION', '4.0.24'); // Granular pet filters
define('BME_VERSION', '4.0.24'); // Granular pet filters
...
require_once BME_PLUGIN_DIR . 'includes/class-bme-market-analytics.php';
require_once BME_PLUGIN_DIR . 'includes/class-bme-analytics-dashboard.php';
...
final class Bridge_MLS_Extractor_Pro {
    ...
    private function init_translation_services() {
        ...
        // Market Analytics - Consolidated Implementation
        $this->container['market_analytics'] = new BME_Market_Analytics(
            $this->container['db'],
            $this->container['cache']
        );

        // Add Analytics Dashboard
        // Instantiated for AJAX and admin requests
        $this->container['analytics_dashboard'] = new BME_Analytics_Dashboard(
            $this->container['db'],
            $this->container['cache'],
            $this->container['market_analytics']  // Uses whichever engine is active
        );
