  ...
  const BME = {
    ...
    initDOMDistributionChart() {
      ...
      this.chartInstances.domDistribution = new Chart(ctx.getContext('2d'), {
        type: 'doughnut',
        data: {
          labels: ['Fast Sales (≤7 days)', 'Normal Sales (8-45 days)', 'Slow Sales (>45 days)'],
          datasets: [
            {
              ...
              ${(virtualTours.virtual_tour_link_1 || virtualTours.virtual_tour_link_2 || virtualTours.virtual_tour_link_3 || listing.virtual_tour_url_unbranded || listing.virtual_tour_url_branded) ? `
                <div class="bme-property-section">
                  ...
                  <div class="bme-virtual-tours">
                    ${virtualTours.virtual_tour_link_1 ? `<p><a href="${virtualTours.virtual_tour_link_1}" target="_blank" class="bme-tour-link">📹 Virtual Tour 1</a></p>` : ''}
                    ${virtualTours.virtual_tour_link_2 ? `<p><a href="${virtualTours.virtual_tour_link_2}" target="_blank" class="bme-tour-link">📹 Virtual Tour 2</a></p>` : ''}
                    ${virtualTours.virtual_tour_link_3 ? `<p><a href="${virtualTours.virtual_tour_link_3}" target="_blank" class="bme-tour-link">📹 Virtual Tour 3</a></p>` : ''}
                    ${listing.virtual_tour_url_unbranded ? `<p><a href="${listing.virtual_tour_url_unbranded}" target="_blank" class="bme-tour-link">📹 Unbranded Tour</a></p>` : ''}
                    ${listing.virtual_tour_url_branded ? `<p><a href="${listing.virtual_tour_url_branded}" target="_blank" class="bme-tour-link">📹 Branded Tour</a></p>` : ''}
                  </div>
                </div>
              ` : ''}
