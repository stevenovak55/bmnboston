...
function mld_enqueue_analytics_assets($hook) {
    ...
    // Chart.js from CDN - load in header so inline scripts can use it
    wp_enqueue_script(
        'chartjs',
...
function mld_analytics_admin_page() {
    ...
    ?>
    <!-- Load Chart.js FIRST before any chart code -->
        ...
        <div class="mld-tab-content">
            ...
            switch ($selected_tab) {
                ...
                case 'features':
                    ...
                    break;
                case 'shortcodes':
                    mld_render_shortcodes_tab($selected_city, $selected_state, $selected_property_type, $selected_date_range);
                    break;
            }
            ?>
        </div>
...
function mld_render_overview_tab($market_summary, $monthly_trends, $appreciation, $city_summary, $market_heat, $date_range = 12) {
    ...
    (function() {
        ...
        // Monthly Price Chart
        const priceCanvas = document.getElementById('monthly-price-chart');
        if (!priceCanvas) {
            console.error('monthly-price-chart canvas not found');
            return;
        }
        ...
        const volumeCanvas = document.getElementById('monthly-volume-chart');
        if (!volumeCanvas) {
            console.error('monthly-volume-chart canvas not found');
            return;
        }
        ...
        console.log('Overview charts initialized with', monthlyData.length, 'data points');
    })();
    </script>
    <?php
}
 ...
 */
function mld_render_shortcodes_tab($city, $state, $property_type, $months) {
    // Escape values for use in shortcodes
    $esc_city = esc_attr($city);
    $esc_state = esc_attr($state);
    $esc_type = esc_attr($property_type);
    $esc_months = intval($months);
    ?>
    <div class="mld-shortcodes-tab">
        <h2>Analytics Shortcodes</h2>
        <p class="description">Copy and paste these shortcodes to display market analytics on any page or post. Click on a shortcode to copy it to your clipboard.</p>

        <div class="mld-shortcode-grid">
            <!-- Market Summary -->
            <div class="mld-shortcode-card">
                <h3>📊 Market Summary</h3>
                <p>Displays a summary card with median price, sales count, days on market, and sale-to-list ratio.</p>
                <div class="mld-shortcode-box" onclick="mldCopyShortcode(this)">
                    <code>[mld_market_summary city="<?php echo $esc_city; ?>" state="<?php echo $esc_state; ?>" months="<?php echo $esc_months; ?>"]</code>
                    <span class="mld-copy-icon">📋</span>
                </div>
                <div class="mld-shortcode-params">
                    <strong>Parameters:</strong>
                    <ul>
                        <li><code>city</code> - City name (required)</li>
                        <li><code>state</code> - State abbreviation</li>
                        <li><code>months</code> - Data range in months (default: 12)</li>
                        <li><code>property_type</code> - Filter by property type (default: all)</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="mld-shortcode-card">
                ...
                <p>Shows the market heat classification (Hot, Warm, Balanced, Cool, Cold) based on supply/demand metrics.</p>
                <div class="mld-shortcode-box" onclick="mldCopyShortcode(this)">
                    <code>[mld_market_heat city="<?php echo $esc_city; ?>" state="<?php echo $esc_state; ?>" style="badge"]</code>
                    <span class="mld-copy-icon">📋</span>
                </div>
                <div class="mld-shortcode-params">
                    <strong>Parameters:</strong>
                    <ul>
                        <li><code>city</code> - City name (required)</li>
                        <li><code>state</code> - State abbreviation</li>
                        <li><code>style</code> - Display style: <code>badge</code>, <code>minimal</code>, or <code>detailed</code></li>
                    </ul>
                </div>
                <div class="mld-shortcode-variants">
                    <strong>Style Variants:</strong>
                    <div class="mld-shortcode-box mld-mini" onclick="mldCopyShortcode(this)">
                        <code>[mld_market_heat city="<?php echo $esc_city; ?>" state="<?php echo $esc_state; ?>" style="minimal"]</code>
                        <span class="mld-copy-icon">📋</span>
                    </div>
                    <div class="mld-shortcode-box mld-mini" onclick="mldCopyShortcode(this)">
                        <code>[mld_market_heat city="<?php echo $esc_city; ?>" state="<?php echo $esc_state; ?>" style="detailed"]</code>
                        <span class="mld-copy-icon">📋</span>
                    </div>
                </div>
            </div>
            ...
            <!-- Feature Premiums -->
            <div class="mld-shortcode-card">
                <h3>💰 Feature Premiums</h3>
                <p>Displays value premiums for property features (pool, waterfront, garage, etc.) based on sold data.</p>
                <div class="mld-shortcode-box" onclick="mldCopyShortcode(this)">
                    <code>[mld_feature_premiums city="<?php echo $esc_city; ?>" state="<?php echo $esc_state; ?>"]</code>
                    <span class="mld-copy-icon">📋</span>
                </div>
                <div class="mld-shortcode-params">
                    <strong>Parameters:</strong>
                    <ul>
                        <li><code>city</code> - City name (required)</li>
                        <li><code>state</code> - State abbreviation</li>
                        <li><code>property_type</code> - Filter by property type (default: Residential)</li>
                        <li><code>months</code> - Data range in months (default: 24)</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="mld-shortcode-card">
                <h3>👥 Top Agents</h3>
                <p>Lists the top performing agents in a market by transaction count and volume.</p>
                <div class="mld-shortcode-box" onclick="mldCopyShortcode(this)">
                    <code>[mld_top_agents city="<?php echo $esc_city; ?>" state="<?php echo $esc_state; ?>" limit="5"]</code>
                    <span class="mld-copy-icon">📋</span>
                </div>
                <div class="mld-shortcode-params">
                    <strong>Parameters:</strong>
                    <ul>
                        <li><code>city</code> - City name (required)</li>
                        <li><code>state</code> - State abbreviation</li>
                        <li><code>limit</code> - Number of agents to display (default: 5)</li>
                        <li><code>months</code> - Data range in months (default: 12)</li>
                    </ul>
                </div>
            </div>
            ...
            <!-- Price by Bedrooms -->
            <div class="mld-shortcode-card">
                <h3>🛏️ Price by Bedrooms</h3>
                <p>Shows average prices broken down by bedroom count.</p>
                <div class="mld-shortcode-box" onclick="mldCopyShortcode(this)">
                    <code>[mld_price_by_bedrooms city="<?php echo $esc_city; ?>" state="<?php echo $esc_state; ?>"]</code>
                    <span class="mld-copy-icon">📋</span>
                </div>
                <div class="mld-shortcode-params">
                    <strong>Parameters:</strong>
            ...
            <!-- Neighborhood Analytics (Original) -->
            <div class="mld-shortcode-card">
                <h3>📈 Neighborhood Analytics</h3>
                <p>Full neighborhood analytics display with price metrics, market velocity, and inventory analysis.</p>
                <div class="mld-shortcode-box" onclick="mldCopyShortcode(this)">
                    <code>[mld_analytics city="<?php echo $esc_city; ?>" state="<?php echo $esc_state; ?>"]</code>
                    <span class="mld-copy-icon">📋</span>
                </div>
                <div class="mld-shortcode-params">
                    <strong>Parameters:</strong>
                    <ul>
                        ...
                        <li><code>period</code> - <code>12_months</code>, <code>6_months</code>, or <code>3_months</code></li>
                        <li><code>show</code> - <code>all</code>, <code>price</code>, <code>velocity</code>, <code>inventory</code>, or <code>market_heat</code></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <!-- Quick Copy Section -->
        <div class="mld-quick-copy-section">
            <h3>Quick Copy - Current City (<?php echo esc_html($city); ?>, <?php echo esc_html($state); ?>)</h3>
            <p>Pre-configured shortcodes for the currently selected city:</p>
            <div class="mld-quick-copy-grid">
                <div class="mld-quick-copy-item" onclick="mldCopyShortcode(this)">
                    <code>[mld_market_summary city="<?php echo $esc_city; ?>" state="<?php echo $esc_state; ?>"]</code>
                    <span class="mld-copy-icon">📋</span>
                </div>
                <div class="mld-quick-copy-item" onclick="mldCopyShortcode(this)">
                    <code>[mld_market_heat city="<?php echo $esc_city; ?>" state="<?php echo $esc_state; ?>"]</code>
                    <span class="mld-copy-icon">📋</span>
                </div>
                <div class="mld-quick-copy-item" onclick="mldCopyShortcode(this)">
                    <code>[mld_feature_premiums city="<?php echo $esc_city; ?>" state="<?php echo $esc_state; ?>"]</code>
                ...
                <div class="mld-quick-copy-item" onclick="mldCopyShortcode(this)">
                    <code>[mld_top_agents city="<?php echo $esc_city; ?>" state="<?php echo $esc_state; ?>"]</code>
                    <span class="mld-copy-icon">📋</span>
                </div>
                <div class="mld-quick-copy-item" onclick="mldCopyShortcode(this)">
                    <code>[mld_price_by_bedrooms city="<?php echo $esc_city; ?>" state="<?php echo $esc_state; ?>"]</code>
        ...
        <!-- Copied notification -->
        <div id="mld-copy-notification" class="mld-copy-notification">Shortcode copied to clipboard!</div>
    </div>

    <style>
        .mld-shortcodes-tab h2 {
            margin-bottom: 10px;
        }
        .mld-shortcodes-tab > .description {
            margin-bottom: 25px;
            font-size: 14px;
        }
        .mld-shortcode-grid {
        ...
        .mld-shortcode-card h3 {
            margin: 0 0 10px 0;
            color: #1e3d6f;
            font-size: 16px;
        }
        .mld-shortcode-card > p {
            color: #666;
            font-size: 13px;
            margin-bottom: 15px;
        }
        ...
        .mld-shortcode-box:hover {
            background: #e0edff;
            border-color: #2c5aa0;
        }
        .mld-shortcode-box code {
            background: none;
            color: #1e3d6f;
            font-size: 12px;
            word-break: break-all;
        }
        .mld-shortcode-box.mld-mini {
            margin-top: 8px;
            padding: 8px 12px;
        }
        .mld-shortcode-box.mld-mini code {
            font-size: 11px;
        }
        .mld-copy-icon {
            font-size: 16px;
        ...
        .mld-shortcode-box:hover .mld-copy-icon {
            opacity: 1;
        }
        .mld-shortcode-params {
            margin-top: 15px;
            padding-top: 12px;
            border-top: 1px solid #eee;
        }
        .mld-shortcode-params strong {
            font-size: 12px;
            color: #333;
        }
        .mld-shortcode-params ul {
            margin: 8px 0 0 0;
            padding-left: 20px;
        }
        .mld-shortcode-params li {
            font-size: 12px;
            color: #666;
            margin-bottom: 4px;
        }
        .mld-shortcode-params li code {
            background: #f5f5f5;
            padding: 1px 5px;
            border-radius: 3px;
            font-size: 11px;
        }
        .mld-shortcode-variants {
            margin-top: 12px;
        }
        .mld-shortcode-variants strong {
            font-size: 12px;
            color: #333;
            display: block;
            margin-bottom: 5px;
        }
        .mld-quick-copy-section {
            background: #f8f9fa;
            border-radius: 8px;
            padding: 20px;
            margin-top: 20px;
        }
        .mld-quick-copy-section h3 {
            margin: 0 0 8px 0;
            color: #1e3d6f;
        }
        .mld-quick-copy-section > p {
            margin: 0 0 15px 0;
            color: #666;
            font-size: 13px;
        }
        ...
        .mld-quick-copy-item:hover {
            background: #f0f6ff;
            border-color: #2c5aa0;
        }
        .mld-quick-copy-item code {
            font-size: 11px;
            background: none;
            color: #333;
        }
        .mld-copy-notification {
            position: fixed;
            bottom: 30px;
            right: 30px;
            background: #28a745;
    ...
    <script>
    function mldCopyShortcode(element) {
        const code = element.querySelector('code');
        const text = code.textContent;

        navigator.clipboard.writeText(text).then(function() {
            // Show notification
            const notification = document.getElementById('mld-copy-notification');
